...
import { Activity, ScrollText, Library } from "lucide-react";
...
export default function Dashboard() {
    ...
    // =========================
    const isAdmin =
        emp_data?.emp_role === "admin" || emp_data?.emp_role === "superadmin";
        ...
        <AuthenticatedLayout>
            ...
            <div className="p-6 space-y-6">
                <h1 className="text-2xl font-bold text-teal-600">
                    <i className="fab fa-pied-piper-alt text-4xl"></i> MRRS
                    Dashboard
                </h1>
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            <div className="p-4 bg-white shadow rounded">
                                ...
                                <p className="text-green-600 text-right font-bold text-2xl">
                            ...
                            <div className="p-4 bg-white shadow rounded">
                                <p className="text-blue-500">
                                    <ScrollText className="inline mr-2" />
                                    Bookings Today
                                </p>
                                <p className="text-blue-600 text-right font-bold text-2xl">
                                    {stats?.bookingsToday}
                                </p>
                            </div>
                            ...
                            <table className="w-full border">
                                <thead>
                                    <tr className="bg-teal-100">
                                        <th className="border px-4 py-2 text-teal-500">
