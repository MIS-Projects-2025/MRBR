                                                            ...
                                                            return (
                                                                <div
                                                                    ...
                                                                    onClick={() => {
                                                                        if (
                                                                            ...
                                                                            alert(
                                                                                "You are not allowed to click this reservation.",
                                                                            );
                                                                            return;
                                                                        }
                                                                ...
                                                                >
                                                                    ...
                                                                    {height >
                                                                        ...
                                                                        <div className="leading-tight">
                                                                            <label
                                                                                className={`font-bold uppercase ${getStatusColor(res)}`}
                                                                            >
                                                                                {
                                                                                    res.status
                                                                                }
                        ...
                        <div className="bg-white p-6 rounded-xl w-full max-w-md">
                            ...
                            <form onSubmit={submit} className="space-y-3">
                                ...
                                >
                                    ...
                                    <Option value="Department Meeting">
                                        Department Meeting
                                    </Option>
                                    <Option value="Management Meeting">
                                        Management Meeting
                                    </Option>
                                    ...
                                    <Option value="Onboarding Session">
                                        Onboarding Session
                                    </Option>
                                    ...
                                    <Option value="Project Kickoff">
                                        Project Kickoff
                                    </Option>
                                    <Option value="Project Review">
                                        Project Review
                                    </Option>
                                    <Option value="Strategy Planning">
                                        Strategy Planning
                                    </Option>
                                    <Option value="Budget Meeting">
                                        Budget Meeting
                                    </Option>
                                    ...
                                    <Option value="Disciplinary Meeting">
                                        Disciplinary Meeting
                                    </Option>
                                    <Option value="Policy Discussion">
                                        Policy Discussion
                                    </Option>

                                    {/* TECH / OPS */}
                                    <Option value="System Demo">
                                        System Demo
                                    </Option>
                                    <Option value="IT Support Session">
                                        IT Support Session
                                    </Option>
                                    <Option value="System Maintenance Meeting">
                                        System Maintenance Meeting
                                    </Option>
                                    <Option value="Incident Review">
                                        Incident Review
                                    </Option>
                                    <Option value="Dev Sprint Planning">
                                        Dev Sprint Planning
                                    </Option>
                                    ...
                                    {/* EVENTS / OTHERS */}
                                    <Option value="Company Announcement">
                                        Company Announcement
                                    </Option>
                                    <Option value="Town Hall Meeting">
                                        Town Hall Meeting
                                    </Option>
                                    <Option value="General Assembly">
                                        General Assembly
                                    </Option>
                                    <Option value="Brainstorming Session">
                    ...
                    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
                        <div className="bg-white w-full max-w-md p-6 rounded-xl space-y-3">
                            ...
                            <div className="text-sm bg-gray-50 p-3 rounded space-y-1">
                                ...
                                <p>
                                    <b>Event:</b>{" "}
                                    {selectedReservation.event_type}
                                </p>
                                <p>
                                    <b>Schedule:</b>{" "}
                                    {moment(
