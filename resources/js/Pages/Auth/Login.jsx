    ...
    bg-gradient-to-br from-teal-500 via-gray-50 to-gray-50"
                ...
                <div className="flex w-full md:w-3/4 items-center justify-center p-6">
                    <div className="relative w-full max-w-lg p-[2px] rounded-3xl overflow-hidden">
                        {/* Rotating Border */}
                        <div className="absolute inset-0 bg-gradient-to-r from-teal-400 via-teal-400 to-teal-500 animate-spin-slow" />

                        {/* Card Content */}
                        <div className="relative bg-teal-100/90 backdrop-blur-xl shadow-2xl rounded-3xl p-10 border-4 border-teal-100">
                            {/* HEADER */}
